...
26. **Midnight crossing over spring forward, closing at the transition:** `America/New_York`, 2026-03-07 session, hours 14:00 to 02:00. Local 02:00 on 2026-03-08 does not exist. Assert `closeInstant` equals the transition instant, and that the session yields two fewer cells than the neighboring nights.
